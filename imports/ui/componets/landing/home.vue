    ...
    <main>
		...
		<div class="container-fluid margin_30_95 pl-lg-5 pr-lg-5">
			<section class="add_bottom_45">
				...
				<!-- /row -->
				<a href="hotels-grid-isotope.html"><strong>View all (157) <i class="arrow_carrot-right ti-direction"></i></strong></a>
			</section>
			<!-- /section -->
			...
			<section>
				...
				<!-- /row -->
				<a href="restaurants-grid-isotope.html"><strong>View all (157) <i class="arrow_carrot-right ti-direction"></i></strong></a>
			</section>
			<!-- /section -->
		</div>
		...
		<div class="call_section">
			<div class="container clearfix">
				<div class="col-lg-5 col-md-6 float-right animated infinite pulse delay-2s">
...
import imageSlider from '/imports/ui/componets/landing/image-slider.vue';
import slickSlider from '/imports/ui/componets/landing/slick-slider.vue';
