				...
				<div class="col-lg-9">
					<article class="blog">
						<div class="row no-gutters">
							<div class="col-lg-7">
								<figure>
									<a href="/news-&-events-details"><img src="img/blog-1.jpg" alt="">
							...
							<div class="col-lg-5">
								<div class="post_info">
									...
									<h3><a href="/news-&-events-details">Nec nihil menandri appellantur ut</a></h3>
					...
					<article class="blog">
						<div class="row no-gutters">
							<div class="col-lg-7">
								<figure>
									<a href="/news-&-events-details"><img src="img/blog-2.jpg" alt="">
										<div class="preview"><span>Read more</span></div>
									</a>
								</figure>
							</div>
					...
					<article class="blog">
						<div class="row no-gutters">
							<div class="col-lg-7">
								<figure>
									<a href="/news-&-events-details"><img src="img/blog-3.jpg" alt="">
										<div class="preview"><span>Read more</span></div>
									</a>
								</figure>
							</div>
					...
					<article class="blog">
						<div class="row no-gutters">
							<div class="col-lg-7">
								<figure>
									<a href="/news-&-events-details"><img src="img/blog-4.jpg" alt="">
										<div class="preview"><span>Read more</span></div>
									</a>
								</figure>
							</div>
